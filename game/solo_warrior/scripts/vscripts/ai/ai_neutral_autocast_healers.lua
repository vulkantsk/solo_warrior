function Spawn( entityKeyValues )
	...
	thisEntity:SetContextThink( "NeutralAutoCasterhealerThink", NeutralAutoCasterhealerThink, 1 )
end

function NeutralAutoCasterhealerThink()
	...
	local allies = FindUnitsInRadius( 
						...
						DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_CUSTOM + DOTA_UNIT_TARGET_BASIC,	--юнитов какого типа ищем 
						DOTA_UNIT_TARGET_FLAG_NOT_MAGIC_IMMUNE_ALLIES + DOTA_UNIT_TARGET_FLAG_FOW_VISIBLE,	--поиск по флагам
