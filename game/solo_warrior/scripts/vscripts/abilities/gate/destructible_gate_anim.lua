LinkLuaModifier( "modifier_destructible_gate_anim",			"abilities/gate/destructible_gate_anim",    		LUA_MODIFIER_MOTION_NONE )

destructible_gate_anim = class({})

function destructible_gate_anim:GetIntrinsicModifierName()
	return "modifier_destructible_gate_anim"
end
