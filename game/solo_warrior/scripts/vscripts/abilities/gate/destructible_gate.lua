LinkLuaModifier( "modifier_destructible_gate",			"abilities/gate/destructible_gate",    		LUA_MODIFIER_MOTION_NONE )

destructible_gate = class({})

function destructible_gate:GetIntrinsicModifierName()
	return "modifier_destructible_gate"
end
...
function modifier_destructible_gate:GetAbsoluteNoDamagePhysical( params )
	return 1
end
